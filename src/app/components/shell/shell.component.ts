      ...
      <nav class="p-2">
        ...
        <div *ngIf="isAdmin()"> 
          <a routerLink="/dashboard" routerLinkActive="bg-cyan-50 text-cyan-600"
            ...
            <mat-icon [style.color]="'#06b6d4'">dashboard</mat-icon>
            <span>Dashboard</span>
          </a>                
        </div>
        ...
        <!-- TENANTS -->
        <div *ngIf="isAdmin()">
          <a routerLink="/admin/tenants" routerLinkActive="bg-cyan-50 text-cyan-600"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-cyan-50 hover:text-cyan-600 transition">
            <mat-icon [style.color]="'#06b6d4'">business</mat-icon>
            <span>Tenants</span>
          </a>
        </div>
        ...
        <div *ngIf="isAdmin()">
          <a routerLink="/admin/usuarios" routerLinkActive="bg-cyan-50 text-cyan-600"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-cyan-50 hover:text-cyan-600 transition">
            <mat-icon [style.color]="'#06b6d4'">admin_panel_settings</mat-icon>
            <span>Usuarios</span>
          </a>
        </div>
      </nav>
